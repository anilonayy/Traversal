namespace _Traversal.Areas.Admin.Models
{
    public class BookingOtelSearchViewModel
    {
            ...
            public string primary_count { get; set; }
            public string count { get; set; }
            public Room_Distribution[] room_distribution { get; set; }
            public Map_Bounding_Box map_bounding_box { get; set; }
            public string total_count_with_filters { get; set; }
            public string unfiltered_count { get; set; }
            public string extended_count { get; set; }
            public string unfiltered_primary_count { get; set; }
        ...
        public class Result
        {
            ...
            public string class_is_estimated { get; set; }
            ...
            public string is_city_center { get; set; }
            ...
            public string children_not_allowed { get; set; }
            public string city_trans { get; set; }
            public string type { get; set; }
            public string currency_code { get; set; }
            public float? review_score { get; set; }
            public string price_is_final { get; set; }
            ...
            public string id { get; set; }
            public string is_mobile_deal { get; set; }
            public string hotel_id { get; set; }
            public string cc1 { get; set; }
            public string genius_discount_percentage { get; set; }
            public string cant_book { get; set; }
            ...
            public string is_beach_front { get; set; }
            public string in_best_district { get; set; }
            public string district_id { get; set; }
            public Bwallet bwallet { get; set; }
            public string is_smart_deal { get; set; }
            public string city_in_trans { get; set; }
            public string district { get; set; }
            public string native_ads_tracking { get; set; }
            public string is_free_cancellable { get; set; }
            public string is_no_prepayment_block { get; set; }
            public string distance_to_cc { get; set; }
            public string unit_configuration_label { get; set; }
            public string preferred_plus { get; set; }
            public string wishlist_count { get; set; }
            public string hotel_name { get; set; }
            public string is_genius_deal { get; set; }
            public string hotel_has_vb_boost { get; set; }
        ...
        {
            public string has_tax_exceptions { get; set; }
            public object gross_price { get; set; }
            public float all_inclusive_price { get; set; }
            public string currency { get; set; }
            public string sum_excluded_raw { get; set; }
            public string has_fine_prstring_charges { get; set; }
            public string has_incalculable_charges { get; set; }
        }
        ...
        {
            public string hotel_eligibility { get; set; }
        }
        ...
        public class Booking_Home
        {
            ...
            public string is_booking_home { get; set; }
